...
$position_options = require( GCO_UX_ELEMENTS_PATH . '/commons/position.php' );
...
add_ux_builder_shortcode( 'gco_ux_image', array(
    'name' => __( 'GCO Image', 'ux-builder'),
    'category' => __( 'Content' ),
    'toolbar_thumbnail' => 'id',
    'thumbnail' =>  gco_ux_builder_thumbnail( 'gco_ux_image' ),
    'wrap' => false,

    'presets' => array(
        array(
            'name' => __( 'Blank' ),
            'content' => '[gco_ux_image][/gco_ux_image]',
        ),
    ),
    ...
    'options' => array(
        ...
        'height' => array(
              ...
              'max' => 1000,
              'step' => 1,
              'helpers' => require( GCO_UX_ELEMENTS_PATH . '/helpers/image-heights.php' ),
               'on_change' => array(
        ...
        'image_hover' => array(
            ...
            'heading' => 'Image Hover',
            'default' => '',
            'options' => require( GCO_UX_ELEMENTS_PATH . '/values/image-hover.php' ),
            'on_change' => array(
                'selector' => '.img-inner',
                'class' => 'image-{{ value }}'
            )
